...
export class OrdinalExpanderItem {
    ...
    constructor(ordinal, expander) {
        ...
        this.noteEditor.addEventListener('selectionchange', () => this.renderNote());
        this.noteEditor.addEventListener('focus', () => this.renderNote());
        this.noteEditor.addEventListener('blur', () => this.renderNote());
    }
    renderOrdinal() {
