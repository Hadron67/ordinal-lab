...
import { button, html, toggleButton, li } from "./domutils.js";
import { rightAngle } from "./svgfonts.js";
...
export class OrdinalExpanderItem {
     ...
     */
    newExpanderItem(ord) {
        const ret = new OrdinalExpanderItem(ord, this.expander);
