...
/** @import { DisplayModeSettings, ExpandedOrdinalRow, LList, OrdinalSublist } from './app.types.js' */
...
/**
 * @param {(HTMLElement | string)[]} elems
 */
function listItem(...elems) {
...
export class OrdinalExpander {
    constructor() {
        ...
        this.ordinalsContainer.className = 'main';
        ...
        this.ordinalMenu.className = 'small-menu';
        {
            ...
            btns.append(listItem(btnExpand), listItem(btnExpandAll), listItem(btnDelete));
            this.ordinalMenu.appendChild(btns);
        }
        ...
        this.optionsPanel = new OptionsPanel('Options', [
            {key: 'showSpecialVeblenFns', description: 'Special Veblen functions', data: {type: 'bool'}},
