...
import { foldAllNestings, maximize, maximizeOne, stringify, successor } from "./ordinals.js";
...
export class OrdinalMarkup {
    ...
    _updateDisplay() {
        ...
        this.ordinalDisplay.replaceChildren(ordinalToMathML(ord, this.displayOptions));
    }
    /**
