/** @import { DisplayOptions, MaximizerOptions, Expression, OrdinalExpression } from './types.js' */
/** @import { OrdinalMarkupConfig } from './app.js' */

import { displayNotationToMathML } from "./display.js";
import { maximize, maximizeOne, stringify, successor, toDisplayNotation } from "./ordinals.js";
...
export class OrdinalMarkup {
    ...
    _updateDisplay() {
        this.ordinalDisplay.replaceChildren(displayNotationToMathML(toDisplayNotation(this.ordinal, this.displayOptions)));
    }
    /**
