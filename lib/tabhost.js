    ...
    constructor(host, page) {
        ...
        this.headerElem.addEventListener('click', () => {
            if (this.host.activeTab !== this) {
                this.select();
            } else if (this.tabHeader) {
                if (this.tabHeader.isConnected) {
                    this.tabHeader.remove();
                } else {
                    this.host.tabheader.append(this.tabHeader);
                }
            }
        });
...
export class TabHost {
     ...
     * @param {Element} tabOtherContainer
     * @param {Element} content
     */
    constructor(tablist, tabheader, tabOtherContainer, content) {
        /** @type {Element} */
        this.tablist = tablist;
        /** @type {Element} */
        this.tabheader = tabheader;
        /** @type {Element} */
        this.tabOtherContainer = tabOtherContainer;
        /** @type {Element} */
