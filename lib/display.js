/** @import { Expression, NestedArrayExpression } from './types' */
            ...
            switch (top.type) {
                ...
                case 'lambda': {
                    ...
                    todo.push(stack => {
                        ...
                        if (hasApplied) {
                            ...
                            ret2.push(mo(CHAR_RIGHT_ARROW), ...body, mo(')'));
                            ret.push(msup(ret2, [mo('('), ...iterations, mo(')')]), mo('('), ...appliedTo, mo(')'));
                        }
                        stack.push(ret);
                    });
                ...
                case 'omega-n': {
                    ...
                    if (sub === 1) {
                        ...
                        todo.push(stack => {
                            const ret = msub([CHAR_UPPER_OMEGA], stack[stack.length - 1]);
                            stack.length--;
                            stack.push([ret]);
                        }, sub);
                    }
                ...
                case 'ocf': {
                    ...
                    if (subscript === 0) {
                        todo.push(stack => {
                            ...
                            stack.length--;
                            stack.push([mn(CHAR_LOWER_PSI), mo('('), ...stack[stack.length - 1], mo(')')]);
                        }, arg);
                    } else {
                        todo.push(stack => {
                            ...
                            stack.length -= 2;
                            stack.push([msub([mn(CHAR_LOWER_PSI)], sub), mo('('), ...arg, mo(')')]);
                        }, subscript, arg);
                    }
                    break;
                }
