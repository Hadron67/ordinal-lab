// /** @import { VeblenFunction, Ordering, NestedArrayCoord, Expression, CompoundExpression, TracedExpressionWithIndex, Omega, OrdinalCollapsingFn, ExpressionType, OrdinalLabOrdinal, Slot, OCFVariant, AdmissibleOmega, PowerExpression, InaccessibleOrdinal } from './types/ordinal.js' */

// import { Expression } from './types/ordinal.js';
// import { panic, pushReversed } from './utils.js';
...
// function separateSuccessor(ord: Expression) {
...
// function separateConstCoef(ord: Expression): [Expression, number] {
//     if (typeof ord === 'number') {
//         return [1, ord];
...
// function isPowerFixedPoint(power: Expression) {
//     while (true) {
...
// function evaluatePower(base: Expression, power: Expression): Expression {
//     if (power === 0) {
//         return 1;
//     } else if (power === 1) {
//         return base;
...
// function evaluateTimes(factors: Expression[]): Expression {
//     const args: Expression[] = [];
//     const toFlatten: Expression[] = [];
//     pushReversed(toFlatten, factors);
//     while (toFlatten.length > 0) {
//         const t = toFlatten.pop() ?? panic();
...
//         return args[0];
//     } else {
//         const args2: Expression[] = [];
//         let [base1, power1] = separatePower(args[0]);
//         const powAccumulator: Expression[] = [power1];
...
// function evaluateTimesSubexpressions(factors: Expression[]) {
...
// export function evaluatePlus(terms: Expression[]): Expression {
//     const args: Expression[] = [];
//     const toFlatten: Expression[] = [];
...
// function separatePower(ord: Expression): [Expression, Expression] {
...
// function outOfBounds(i: number) {
//     return panic(`index ${i} is out of bounds`);
// }

// export function getChild(expr: Expression, i: number): Expression {
...
//             default: return unreachable();
//         }
//         default: panic(`unimplement type ${expr.type}`);
//     } else {
//         outOfBounds(i);
//     }
// }
...
//     return ord;
// }
// function replacePart(subexpressions: Expression[], arg1: number, arg2: number) {
